...
public class BZIP2Compressor {
	 ...
	 * 
	 * @param decompressed       An empty byte array where we put the decompressed
	 *                           data in.
	 ...
	 */
	public static int decompress(byte[] decompressed, int decompressedLength, byte[] archiveData, int compressedSize,
			int startOffset) {
	...
	public static void decompress(BZIP2BlockEntry bzip2BlockEntry) {
		...
		while (bool_28_) {
			...
			for (int i_48_ = 0; i_48_ < i_36_; i_48_++) {
				...
				method145(bzip2BlockEntry.anIntArrayArray3095[i_48_], bzip2BlockEntry.anIntArrayArray3082[i_48_],
						bzip2BlockEntry.anIntArrayArray3099[i_48_], bzip2BlockEntry.aByteArrayArray3098[i_48_], i_49_,
						i_50_, i_35_);
			...
			int i_62_;
			int i_63_;
			for (i_63_ = method152(i_61_, bzip2BlockEntry); i_63_ > is[i_61_]; i_63_ = i_63_ << 1 | i_62_) {
				i_61_++;
			...
			while (i_64_ != i_52_) {
				if (i_64_ == 0 || i_64_ == 1) {
					...
					i_65_++;
					i_30_ = (bzip2BlockEntry.aByteArray3107[(bzip2BlockEntry.aByteArray3101[bzip2BlockEntry.anIntArray3092[0]]
							& 0xff)]);
					bzip2BlockEntry.anIntArray3075[i_30_ & 0xff] += i_65_;
					for (/**/; i_65_ > 0; i_65_--) {
						anIntArray5786[i_59_] = i_30_ & 0xff;
						i_59_++;
					}
				} else {
					int i_68_ = i_64_ - 1;
					if (i_68_ < 16) {
						...
						for (/**/; i_68_ > 0; i_68_--) {
							bzip2BlockEntry.aByteArray3101[i_69_ + i_68_] = bzip2BlockEntry.aByteArray3101[i_69_ + i_68_
									- 1];
						}
						...
						for (/**/; i_71_ > 0; i_71_--) {
							bzip2BlockEntry.anIntArray3092[i_71_]--;
							bzip2BlockEntry.aByteArray3101[bzip2BlockEntry.anIntArray3092[i_71_]] = (bzip2BlockEntry.aByteArray3101[bzip2BlockEntry.anIntArray3092[i_71_
									- 1] + 16 - 1]);
						}
						...
						if (bzip2BlockEntry.anIntArray3092[0] == 0) {
							...
							for (int i_75_ = 15; i_75_ >= 0; i_75_--) {
								for (int i_76_ = 15; i_76_ >= 0; i_76_--) {
									bzip2BlockEntry.aByteArray3101[i_74_] = (bzip2BlockEntry.aByteArray3101[(bzip2BlockEntry.anIntArray3092[i_75_]
											+ i_76_)]);
									i_74_--;
								}
					...
					bzip2BlockEntry.anIntArray3075[(bzip2BlockEntry.aByteArray3107[i_29_ & 0xff] & 0xff)]++;
					anIntArray5786[i_59_] = bzip2BlockEntry.aByteArray3107[i_29_ & 0xff] & 0xff;
					i_59_++;
					if (i_54_ == 0) {
						i_53_++;
						i_54_ = 50;
			...
			for (int i_80_ = 0; i_80_ < i_59_; i_80_++) {
				i_30_ = (byte) (anIntArray5786[i_80_] & 0xff);
				anIntArray5786[(bzip2BlockEntry.anIntArray3091[i_30_ & 0xff])] |= i_80_ << 8;
				bzip2BlockEntry.anIntArray3091[i_30_ & 0xff]++;
			}
			bzip2BlockEntry.anInt3106 = anIntArray5786[bzip2BlockEntry.anInt3083] >> 8;
	...
	public static int method152(int arg0, BZIP2BlockEntry arg1) {
		...
		for (;;) {
			if (arg1.anInt3088 >= arg0) {
				int i_93_ = (arg1.anInt3078 >> arg1.anInt3088 - arg0 & (1 << arg0) - 1);
				arg1.anInt3088 -= arg0;
				i = i_93_;
				break;
			}
			arg1.anInt3078 = (arg1.anInt3078 << 8 | arg1.compressed[arg1.startOffset] & 0xff);
			arg1.anInt3088 += 8;
			arg1.startOffset++;
			arg1.anInt3085++;
		}
	...
	public static void method145(int[] arg0, int[] arg1, int[] arg2, byte[] arg3, int arg4, int arg5, int arg6) {
		int i = 0;
