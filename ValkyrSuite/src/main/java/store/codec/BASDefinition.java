...
public class BASDefinition implements AbstractDefinition, Cloneable {
	...
	public void decode(InputStream buffer) {
		try {
			while (true) {
				...
				// added opcode
				if (1 == opcode) {
					idle = buffer.readBigSmart(); // Stand animation
					walking = buffer.readBigSmart(); // Walk animation
				} else if (2 == opcode)
					anInt3755 = buffer.readBigSmart();
				else if (opcode == 3)
					anInt3722 = buffer.readBigSmart();
				else if (4 == opcode)
					anInt3727 = buffer.readBigSmart();
				else if (5 == opcode)
					anInt3728 = buffer.readBigSmart();
				else if (opcode == 6)
					running = buffer.readBigSmart(); // Run animation
				else if (opcode == 7)
					anInt3749 = buffer.readBigSmart();
				else if (opcode == 8)
					anInt3746 = buffer.readBigSmart();
				else if (9 == opcode)
					anInt3724 = buffer.readBigSmart();
				else if (26 == opcode) {
					...
					anInt3715 = buffer.readBigSmart();
				else if (39 == opcode)
					anInt3733 = buffer.readBigSmart();
				else if (opcode == 40)
					backwards = buffer.readBigSmart(); // Walk backwards backwards anim
				else if (opcode == 41)
					strafe_right = buffer.readBigSmart(); // Straif right anim
				else if (42 == opcode)
					strafe_left = buffer.readBigSmart(); // Straif left anim
				else if (opcode == 43)
					anInt3738 = buffer.readBigSmart();
				else if (44 == opcode)
					anInt3754 = buffer.readBigSmart();
				else if (opcode == 45)
					anInt3716 = buffer.readUnsignedShort();
				else if (46 == opcode)
					anInt3729 = buffer.readBigSmart();
				else if (opcode == 47)
					anInt3743 = buffer.readBigSmart();
				else if (48 == opcode)
					anInt3731 = buffer.readBigSmart();
				else if (opcode == 49)
					anInt3739 = buffer.readBigSmart();
				else if (50 == opcode)
					anInt3737 = buffer.readBigSmart();
				else if (opcode == 51)
					anInt3730 = buffer.readBigSmart();
				else if (52 == opcode) {
					int length = buffer.readUnsignedByte();
					anIntArray3712 = new int[length];
					anIntArray3713 = new int[length];
					for (int index = 0; index < length; index++) {
						anIntArray3712[index] = buffer.readBigSmart();
	...
	public byte[] encode() {
		...
		stream.writeBigSmart(walking);

		if (this.anInt3755 != -1) {
			stream.writeByte(2);
			stream.writeBigSmart(anInt3755);
		}

		if (this.anInt3722 != -1) {
			stream.writeByte(3);
			stream.writeBigSmart(anInt3722);
		}

		if (this.anInt3727 != -1) {
			stream.writeByte(4);
			stream.writeBigSmart(anInt3727);
		}

		if (this.anInt3728 != -1) {
			stream.writeByte(5);
			stream.writeBigSmart(anInt3728);
		}

		if (this.running != -1) {
			stream.writeByte(6);
			stream.writeBigSmart(running);
		}

		if (this.anInt3749 != -1) {
			stream.writeByte(7);
			stream.writeBigSmart(anInt3749);
		}

		if (this.anInt3746 != -1) {
			stream.writeByte(8);
			stream.writeBigSmart(anInt3746);
		}

		if (this.anInt3724 != -1) {
			stream.writeByte(9);
			stream.writeBigSmart(anInt3724);
		}
		...
		if (this.anInt3715 != -1) {
			stream.writeByte(38);
			stream.writeBigSmart(anInt3715);
		}

		if (this.anInt3733 != -1) {
			stream.writeByte(39);
			stream.writeBigSmart(anInt3733);
		}

		if (this.backwards != -1) {
			stream.writeByte(40);
			stream.writeBigSmart(backwards);
		}

		if (this.strafe_right != -1) {
			stream.writeByte(41);
			stream.writeBigSmart(strafe_right);
		}

		if (this.strafe_left != -1) {
			stream.writeByte(42);
			stream.writeBigSmart(strafe_left);
		}

		if (this.anInt3738 != -1) {
			stream.writeByte(43);
			stream.writeBigSmart(anInt3738);
		}

		if (this.anInt3754 != -1) {
			stream.writeByte(44);
			stream.writeBigSmart(anInt3754);
		}
		...
		if (this.anInt3729 != -1) {
			stream.writeByte(46);
			stream.writeBigSmart(anInt3729);
		}

		if (this.anInt3743 != -1) {
			stream.writeByte(47);
			stream.writeBigSmart(anInt3743);
		}

		if (this.anInt3731 != -1) {
			stream.writeByte(48);
			stream.writeBigSmart(anInt3731);
		}

		if (this.anInt3739 != -1) {
			stream.writeByte(49);
			stream.writeBigSmart(anInt3739);
		}

		if (this.anInt3737 != -1) {
			stream.writeByte(50);
			stream.writeBigSmart(anInt3737);
		}

		if (this.anInt3730 != -1) {
			stream.writeByte(51);
			stream.writeBigSmart(anInt3730);
		}
		...
		if (anIntArray3712 != null && anIntArray3713 != null) {
			...
			stream.writeByte(length);
			for (int index = 0; index < length; index++) {
				stream.writeBigSmart(anIntArray3712[index]);
		...
		stream.writeByte(0);
		byte[] offset_stream = new byte[stream.getPosition()];
