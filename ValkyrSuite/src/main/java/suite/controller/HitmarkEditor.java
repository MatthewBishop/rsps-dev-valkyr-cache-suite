...
//
//	@FXML
//	private ListView<HitmarkDefinition> hitmarks;
//	@FXML
//	private TextField font, style, left, middle, right, hspeed, vspeed, markText, vTextOffset, fadeSpeed, anInt3861,
//			anInt3863, search_bar;
//	@FXML
...
//			SpriteLoader.getSprites()[def.leftSprite].decodeImage(Selection.cache, 8, def.leftSprite, 0);
...
//			SpriteLoader.getSprites()[def.middleSprite].decodeImage(Selection.cache, 8, def.middleSprite, 0);
...
//			SpriteLoader.getSprites()[def.rightSprite].decodeImage(Selection.cache, 8, def.rightSprite, 0);
...
//			SpriteLoader.getSprites()[def.attackStyle].decodeImage(Selection.cache, 8, def.attackStyle, 0);
...
//					(float) fontColor.getValue().getGreen(), (float) fontColor.getValue().getBlue(),
