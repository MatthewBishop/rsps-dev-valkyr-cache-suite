...
public class RenderAnimations {
	...
	@FXML
	private ListView<BASDefinition> animation_list;

	@FXML
	private CheckBox aBoolean3756;

	@FXML
	private TextField anIntArrayArray3710, idle, anIntArray3712, anIntArray3713, anInt3714, anInt3715, anInt3716,
			walking, strafe_right, anInt3720, running, anInt3722, strafe_left, anInt3724, anInt3726, anInt3727,
			anInt3728, anInt3729, anInt3730, anInt3731, anIntArray3732, anInt3733, anInt3734, anInt3735, anInt3736,
			anInt3737, anInt3738, anInt3739, anInt3740, backwards, anIntArray3742, anInt3743, anInt3744, anInt3745,
			anInt3746, anInt3747, anInt3748, anInt3749, anInt3750, anInt3751, anInt3752, anIntArrayArray3753, anInt3754,
			anInt3755, search_bar;
	...
	public void startup(CustomTab tab, boolean refresh, int lastid) {
		...
		create.setOnAction((ActionEvent event) -> {
			...
			try {
				...
				InformationDialogue.create("Error", "An error has occured.", AlertType.ERROR,
						"Unable to create new render animation.", "", StringUtilities.getStackTrace(e));
				e.printStackTrace();
			}
		});
